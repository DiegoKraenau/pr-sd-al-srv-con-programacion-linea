package com.grupogloria.prsdalsrvconprogramacionlinea.lineprogramminglist.aop.logging;
...
public class ElkLogger {	
	...
	@Around("@annotation(com.grupogloria.prsdalsrvconprogramacionlinea.lineprogramminglist.aop.logging.LogMethodCall)")
